...
public:
    ...
    void removeItem(string name, int age)
    {
        ...
        throw out_of_range("Item not found remove item");
    }
...
void printForward(DLL *dll, int index)
{
    ...
    {
        throw out_of_range("Index out of range printqueue");
    }
...
void printReverse(DLL *dll, int index)
{
    ...
    if (index < 0 || index > dll->size())
    {
        throw out_of_range("Index out of range print ps");
    }
